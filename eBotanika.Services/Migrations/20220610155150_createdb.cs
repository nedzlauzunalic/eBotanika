        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdresaDostave = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SvrhaID = table.Column<int>(type: "int", nullable: false),
                    BiljkeID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 6, 10, 17, 51, 49, 480, DateTimeKind.Local).AddTicks(8876), "korisnik@live.com", "Mobile", "mobile", "bUBHhasx3aUpr7cmjozMzIeL35c=", "zthomrUyhZjeapvj5KYL+A==", "Mobile", "+38762345678" },
                    { 2, new DateTime(2022, 6, 10, 17, 51, 49, 480, DateTimeKind.Local).AddTicks(8967), "adnan@live.com", "Adnan", "adnan", "bUBHhasx3aUpr7cmjozMzIeL35c=", "zthomrUyhZjeapvj5KYL+A==", "Pobric", "+38762345676" }
                });
