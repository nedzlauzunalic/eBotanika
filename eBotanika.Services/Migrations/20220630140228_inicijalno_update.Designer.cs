...
namespace eBotanika.Services.Migrations
{
    ...
    [Migration("20220630140228_inicijalno_update")]
    partial class inicijalno_update
    {
            ...
            modelBuilder.Entity("eBotanika.Services.Database.Korisnik", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikID = 1,
                            DatumRodjenja = new DateTime(2022, 6, 30, 16, 2, 27, 691, DateTimeKind.Local).AddTicks(8333),
                        ...
                        {
                            KorisnikID = 2,
                            DatumRodjenja = new DateTime(2022, 6, 30, 16, 2, 27, 691, DateTimeKind.Local).AddTicks(8370),
